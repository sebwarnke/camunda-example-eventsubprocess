package org.camunda.warnke.examples.eventsubprocess;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "eventsubprocess";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "eventsubprocess.war")
            ...
            .addPackages(false, "org.camunda.warnke.examples.eventsubprocess") // not recursive to skip package 'nonarquillian'
